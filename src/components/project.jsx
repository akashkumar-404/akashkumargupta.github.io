        ...
        className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
           ...
           mx-auto content-div'>
                <div className='opacity-0 group-hover:opacity-100'>
                 ...
                 {/*3 rd project  */}
                 <div style={{backgroundImage:`url(${Heliverse})`}}   className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center
           mx-auto content-div'>
                <div className='opacity-0 group-hover:opacity-100'>
                    <span className='text-2xl font-bold text-white tracking-wider'>
                    Redux Application
                        ...
                        <div className='pt-8 text-center'>
                            <a href="https://akashkumar404-gmail-com-makes-great-sites-0248a.netlify.app/">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                                    Demo
                                </button>
                            </a>
                            <a href="https://github.com/akashkumar-404/Heliverse">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                                    Code
                                </button>
                            </a>
