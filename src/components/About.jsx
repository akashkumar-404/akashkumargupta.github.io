    ...
    <div name='about' className='w-full h-screen bg-[#0a192f] text-gray-300'>
        <div className='flex flex-col justify-center items-center w-full h-full'>
            <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
                <div className='sm:text-right pb-8 pl-4 ml-120px  w-[550px] '>
            ...
            <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-6'>
                ...
                <div>
                    <p>I am very passionate about coding. I have been doing FULL-TIME
                        course with Masai School.There I am learning Data Structures and Algorithm,
                        JavaScript,React etc.There I have been doing 1100+ hrs of coding.I have build some of the Projects.
                        Feel Free to checkout those! 
                    </p>
